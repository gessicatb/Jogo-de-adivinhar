...
**1.** Adquira o Python de maneira segura pela Microsoft Store:  
👉 [Python 3.13 — Microsoft Store](https://apps.microsoft.com/detail/9PNRBTZXMB4Z?hl=neutral&gl=BR&ocid=pdpshare)

**2.** Após a instalação, aperte **Windows + R**

**3.** Digite `cmd` e aperte **ENTER**

**4.** Com o terminal aberto, chame o Python com o seguinte comando:
```
python
```
...
**6.** Aperte **ENTER** duas vezes e comece a jogar pelo terminal! 🚀
